...
public class ExpoPencilKitView: ExpoView, PKCanvasViewDelegate, PKToolPickerObserver, UIScrollViewDelegate {
    ...
    private func setupCanvasView() {
        // Pencil draws, fingers scroll/zoom (GoodNotes-style)
    ...
    // PKCanvasView is a UIScrollView — zooming is handled natively.
    // Fingers = scroll/zoom, Apple Pencil = drawing (drawingPolicy = .pencilOnly)
